...
my.methods = c("G", "Lo", "ECC", "HPML", "Chains")
...
FolderCC = paste(FolderData, "/Set-Up-7-c", sep="")
...
Folder.2020 = paste(FolderCCA, "/Set-Up-7-c", sep="")
...
datasets.names = c("emotions", "EukaryotePseAAC", "flags",          
                   "GnegativeGO", "GnegativePseAAC", "GpositiveGO",
                   "HumanPseAAC", "langlog", "medical",      
                   "ng20", "PlantGO", "PlantPseAAC", "VirusGO",
                   "slashdot", "VirusPseAAC", "yeast", "Yelp")
