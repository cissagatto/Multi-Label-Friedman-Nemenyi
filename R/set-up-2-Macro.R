...
Folder.CSVs = paste(FolderSetUp, "/Macro-F1-CSVs", sep="")
...
FolderAbril2023 = paste(FolderAnalysed, "/Set-Up-2-Macro-F1", sep="")
...
#
##############################################################################
resultado.ma = ranking.for.all.measures(folder.names.csv = folder.names.csv, 
                                        nomes.measures = nomes.measures,
                                        my.methods = my.methods.ma, 
                                        pastas = pastas, 
                                        res.mm = res.mm)
...
WinLossTiePlotMa(FolderWLT = FolderWLT, 
                 max.value = 120, 
                 half.value = 48, 
                 measures = medidas, 
                 title = "",
