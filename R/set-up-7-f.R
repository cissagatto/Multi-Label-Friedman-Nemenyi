...
FolderCC = paste(FolderData, "/Set-Up-7-f", sep="")
...
Folder.2020 = paste(FolderCCA, "/Set-Up-7-f", sep="")
...
name.dir = "All.v3"
root.dir = Folder.2020 
ranking.path = "~/Multi-Label-Friedman-Nemenyi/Analysed/Set-Up-7-f/Rankings-2"
res3 = Friedman.Nemenyi.v1(path = ranking.path,
                           name.dir = name.dir, 
                           root.dir = root.dir)
...
compute.all.tie.loss.win(folder.names.csv,
                         Folder.CSVs, 
                         FolderWTP,
                         my.methods)
